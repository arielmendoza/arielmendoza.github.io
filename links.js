const affiliateLinks = {
  ...
  'martillo-bahco-428-16': { url: 'https://amzn.to/3Q4rS5t', name: 'Martillo de uña Bahco 428-16' },
  ...
  'metro-stanley-powerlock': { url: 'https://amzn.to/3O7pQ8r', name: 'Flexómetro Stanley Powerlock' },
  ...
  'bascula-cocina-tefal': { url: 'https://amzn.to/3U3vW4x', name: 'Báscula de Cocina Tefal' },
  
  // Aires Acondicionados
  'aire-acondicionado-daitsu-asd12': { url: 'https://amzn.to/4Y5zA6b', name: 'Aire Acondicionado Daitsu ASD12' },
  'aire-portatil-olimpia-dolceclima': { url: 'https://amzn.to/3C7dE8f', name: 'Aire Portátil Olimpia Splendid Dolceclima' },
  ...
  'limpiafondos-zodiac-mx6': { url: 'https://amzn.to/4W7xY8z', name: 'Limpiafondos Hidráulico Zodiac MX6' },
  'kit-analisis-agua-bayrol': { url: 'https://amzn.to/3A9bC0d', name: 'Kit Análisis Agua Piscina Bayrol' },
  
  // Césped Artificial
  'cesped-artificial-20mm': { url: 'https://amzn.to/4dYJfQj', name: 'Césped Artificial 20mm' },
  'cola-cesped-artificial-6750kg': { url: 'https://amzn.to/4kQUYmo', name: 'Cola para Césped Artificial 6.750kg' },
  'cola-cesped-artificial-2250kg': { url: 'https://amzn.to/4jYRKwo', name: 'Cola para Césped Artificial 2.250kg' },
  'banda-union-cesped': { url: 'https://amzn.to/4e25wgm', name: 'Banda de Unión para Césped' },
  'espatula-dentada-cola': { url: 'https://amzn.to/45dIiS1', name: 'Espátula Dentada para Cola' },
  'cuter-profesional': { url: 'https://amzn.to/43ZvVa1', name: 'Cúter Profesional' },
  'guantes-trabajo-cesped': { url: 'https://amzn.to/449Qkdx', name: 'Guantes de Trabajo' },
  
  // Herramientas Esenciales
  'kit-herramientas-basico-stanley': { url: 'https://amzn.to/4E1fG2h', name: 'Kit Básico de Herramientas Stanley' },
  'caja-herramientas-keter': { url: 'https://amzn.to/3I3jK4l', name: 'Caja de Herramientas Keter' },
  
  // Herramientas Baratas
  'taladro-economico-tacklife': { url: 'https://amzn.to/4M5nO6p', name: 'Taladro Económico Tacklife' },
  'sierra-manual-bahco-2600': { url: 'https://amzn.to/3Q7rS8t', name: 'Sierra de Mano Bahco 2600' }
};

// Para uso en Node.js (si fuera necesario en el futuro)
